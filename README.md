...
1. **Clone this repository**
   ...
   ```bash
   git clone https://github.com/JacobPEvans/proxmox-ansible.git
   cd proxmox-ansible
   ```
...
[lint-badge]: https://github.com/JacobPEvans/proxmox-ansible/actions/workflows/ansible-lint.yml/badge.svg
[lint-url]: https://github.com/JacobPEvans/proxmox-ansible/actions/workflows/ansible-lint.yml
[molecule-badge]: https://github.com/JacobPEvans/proxmox-ansible/actions/workflows/molecule.yml/badge.svg
[molecule-url]: https://github.com/JacobPEvans/proxmox-ansible/actions/workflows/molecule.yml
